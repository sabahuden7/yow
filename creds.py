class Creds():
    ...
    TG_TOKEN = "1883730639:AAFDTJx55MJcCFdKkcnr9JoS-Sj_xphlwos"
    ...
    TEAMDRIVE_FOLDER_ID = "1aF9ahkBEF1mhc4xKc7yRDqPLUTi4f_Ax"
    
    # Id of Team drive 
    TEAMDRIVE_ID = "1KNbK_tRcbs6Bpf-sChgYP2--TDCeBSmF"
